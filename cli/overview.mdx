---
title: CLI
description: 'Publish announcements from your terminal or CI pipeline'
---

# updates.page CLI

The `@updatespage/cli` package lets you create and publish announcements from your terminal — perfect for release scripts and CI pipelines.
...
Creates the announcement without publishing it:
