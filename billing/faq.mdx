...
<AccordionGroup>
  ...
  <Accordion title="Do you offer annual billing?">
    Yes — every paid plan has an annual option with two months free: Pro is $290/year and Business is $990/year. Switch between monthly and annual any time from **Account → Billing → Change plan**; unused time is credited automatically.
  </Accordion>
