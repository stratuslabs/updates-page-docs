...
description: 'Add the announcements panel to your app with one script tag'
---

# Installing an Embed

The embed adds a trigger button to your app that opens a slide-over panel with your latest announcements.
...
That's it — clicking the button opens the slide-over panel with your latest announcements.
