...
description: 'Add the What’s New panel to your app with one script tag'
---
...
1. In the dashboard, go to **Settings → Developer → Embeds**
2. Click **New Embed**
...
<html>
  ...
  <body>
    ...
    <!-- updates.page embed (copy your exact tag from Settings → Developer → Embeds) -->
    <script type="text/javascript" src="https://.../<embed-id>.js"></script>
  </body>
</html>
```
  ...
  <Accordion title="React">
    ...
    function App() {
      useEffect(() => {
        ...
        // Use the exact URL from your dashboard (Settings → Developer → Embeds)
