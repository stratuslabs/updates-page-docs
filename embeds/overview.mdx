...
description: 'Show your latest announcements inside your app or website'
---

# Embeds

Bring your changelog directly into your product with an embeddable announcements panel.
...
An embed is a single script tag you paste into your site. It renders a trigger button where the tag is placed, and clicking the button opens a slide-over panel showing your latest announcements — users never have to leave your app to see what's new.
