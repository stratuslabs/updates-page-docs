...
<Note>
  Embeds are available on the **Pro** plan and above. See [Installing an Embed](/embeds/widget) for setup.
</Note>
...
1. In the dashboard, go to **Settings → Developer → Embeds** and open your embed in the editor
...
```javascript
// Open the What’s New panel when a nav item is clicked
