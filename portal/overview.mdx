...
<CardGroup cols={2}>
  ...
  <Card title="Email subscribers" icon="envelope">
    Collect email sign-ups and sync them to your email tool or your own endpoint
  </Card>
...
| **Subscriptions** | The email subscription form, the RSS button, and connected apps |
| **Subscribers** | Everyone who has signed up for email updates |
...
Readers who'd rather get updates by email can [subscribe with their email address](/portal/subscriptions) instead. That form is off by default.
