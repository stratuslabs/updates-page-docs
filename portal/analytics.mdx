...
<Note>
  Built-in analytics are privacy-friendly — we don't track personal information or use third-party cookies. Views are counted on your portal; views inside an [embed](/embeds/overview) aren't counted yet.
</Note>

## Google Analytics

<Note>
  Google Analytics and Fathom are available on the **Pro** plan and above.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Is my changelog getting traffic?">
    ...
    - Linking your [RSS feed](/portal/overview#rss-feed) from your docs or release notes
  </Accordion>
</AccordionGroup>
